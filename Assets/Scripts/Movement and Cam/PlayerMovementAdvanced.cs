...
public class PlayerMovementAdvanced : MonoBehaviour
{
    ...
    private void MyInput()
    {
        ...
        {
            _playerObject.localScale = new Vector3(transform.localScale.x, crouchYScale, transform.localScale.z);
            if (grounded)
        ...
        {
            _playerObject.localScale = new Vector3(transform.localScale.x, startYScale, transform.localScale.z);
        }
    }
